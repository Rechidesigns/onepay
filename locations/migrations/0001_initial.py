# Generated by Django 4.2.2 on 2023-07-01 14:53
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(help_text="English name of country", max_length=255, verbose_name="Country Name"),
                ),
                (
                    "phone_code",
                    models.CharField(
                ...
                (
                    "iso2",
                    models.CharField(
                        blank=True, help_text="Two-letter country code", max_length=2, null=True, verbose_name="ISO2"
                    ),
                ),
                (
                    "native",
                    models.CharField(
                        blank=True, help_text="Localized or native language of country.", max_length=255, null=True
                    ),
                ),
                (
                    "created_date",
